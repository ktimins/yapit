...
* Playback now stops with an error after three blocks in a row fail to synthesize, instead of silently skipping through the whole document (and saving a reading position the listener never reached).
