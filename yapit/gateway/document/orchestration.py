"""Document extraction orchestration: caching, page assembly, per-page billing."""
...
async def check_extraction_cache(
...
async def process_with_billing(
    ...
    # 4. Bill all successful pages in one short DB session
    if billing_records:
